<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action([\App\Http\Controllers\SalesCommissionAgentController::class, 'update'], [$user->id]), 'method' => 'POST', 'id' => 'sale_commission_agent_form' ]) !!}
@csrf
    @method('PUT')
    ...
    <div class="modal-body">
      ...
      <div class="col-md-6">
        <div class="form-group">
          <label for="individual_commission">Individual Commission</label>
      ...
      <div class="col-md-6">
        <div class="form-group">
          <label for="fixed_commission">Fixed Commission</label>
            {!! Form::text('fixed_commission', @num_format($user->fixed_commission), ['class' => 'form-control input_number', 'placeholder' => 'Sale Fixed Commission (%)', 'required' ]); !!}
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
          <label for="global_commission">Global Commission</label>
            {!! Form::text('global_commission', @num_format($user->global_commission), ['class' => 'form-control input_number', 'placeholder' => 'Sale Global Commission (%)', 'required' ]); !!}
        </div>
      </div>
    ...
    <div class="modal-footer">
      <button type="submit" class="tw-dw-btn tw-dw-btn-primary tw-text-white"  id="update_sale_commission">@lang( 'messages.save' )</button>
