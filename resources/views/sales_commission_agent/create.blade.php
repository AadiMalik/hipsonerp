    ...
    <div class="modal-body">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="text" name="fixed_commission" id="fixed_commission" min="0" class="form-control input_number" placeholder="Sale Fixed Commission (%)" required>
        </div>
      </div>
<div class="col-md-6">
        <div class="form-group">
          <label for="global_commission">Global Commission</label>
          <input type="text" name="global_commission" id="global_commission" min="0" class="form-control input_number" placeholder="Sale Global Commission (%)" required>
        </div>
      </div>
      </div>
    </div>
